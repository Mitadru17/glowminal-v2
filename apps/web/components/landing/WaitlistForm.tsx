          ...
          >
            ...
            <div className="relative w-full flex flex-col sm:flex-row gap-3">
              <input
                ...
                autoCorrect="off"
                spellCheck="false"
                className={`w-full h-14 rounded-2xl border px-6 text-[15px] placeholder:text-text-secondary focus:outline-none focus:ring-1 focus:ring-primary disabled:opacity-50 transition-all duration-300 ${
                  theme === 'dark'
              ...
              <button
                type="submit"
                disabled={uiState !== 'idle' && uiState !== 'error'}
                className={`group relative flex h-14 w-full sm:w-auto sm:min-w-[160px] flex-shrink-0 items-center justify-center overflow-hidden rounded-2xl px-8 font-medium shadow-sm transition-all hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-90 whitespace-nowrap active:scale-[0.98] touch-manipulation ${
                  theme === 'dark'

...
export function HeroContent() {
  ...
  return (
    ...
    >
      <motion.div 
        initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.8, ease: EXPENSIVE_EASING }}
      ...
      <h1 className="max-w-5xl text-[12vw] leading-[0.9] tracking-tighter text-text-primary sm:text-[7rem] md:text-[9rem] font-light text-shadow-sm">
        ...
        <motion.span 
          ...
          transition={{ delay: 0.4, duration: 1, ease: EXPENSIVE_EASING }}
      ...
      <motion.div 
        initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 0.8, ease: EXPENSIVE_EASING }}
        className="mt-12"
      >
